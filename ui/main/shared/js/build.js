    ...
    self.SpecIdToGridMap = ko.observable(
        {
			...
			"/pa/units/land/tracking_station/tracking_station.json": ["utility", 50],
            ...
            "/pa/units/orbital/hailfire/hailfire.json": ["orbital units", 5],
            "/pa/units/orbital/orbital_laser/orbital_laser.json": ["orbital units", 6],
			"/pa/units/orbital/hammerhead/hammerhead.json": ["orbital units", 7],
			"/pa/units/orbital/excal/excal.json": ["orbital units", 8],
			...
			"/pa/units/orbital/orbital_anti_nuke/orbital_anti_nuke.json": ["orbital structures", 140],
